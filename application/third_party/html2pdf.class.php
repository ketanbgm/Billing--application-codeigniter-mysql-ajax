...
if (!defined('__CLASS_HTML2PDF__')) {
   ...
   /* require_once(dirname(__FILE__).'/_class/exception.class.php');
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'L', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
		...
		/*
			By: Shruti
			DEsc: to return the number of pages generated in pdf view.
			Used: RO Bill Report 
		*/
