...
function HTML2FPDF($orientation='L',$unit='mm',$format='A4')
{
//! @desc Constructor
//! @return An object (a class instance)
  ...
  $this->row=-1; 
	...
	$this->fontlist=array("tunga","arial","times","courier","helvetica","symbol","monospace","serif","sans");
	$this->issetfont=true;
	...
	foreach($a as $i => $e)
	{
      ...
      //			$this->lineheight = (5*$this->FontSizePt)/11; //should be inside printbuffer?
        ...
        $version = str_replace('.','',$version);
       	//if ($version >= 430) $e = lesser_entity_decode($e,ENT_QUOTES,'cp1252');
